...
def build_full_classifier(df, cls='cls', rs=0):
    ...
    classifier = RandomForestClassifier(n_estimators=100, max_depth=None, min_samples_split=490, random_state=rs, bootstrap=True, balance_classes=True, compute_importances=True, oob_score=True)
...
if __name__ == '__main__':
    ...
    annot_file = 'trainset-HGMDcls-CADDannots.csv'
    output_file = 'RF-CADD-HGMD-trainontrain'

#    rd = RF_DIR+'/src/data_output/'

    hits = read_csv('trainset-HGMDcls-CADDannots.csv', index_col=0) 
